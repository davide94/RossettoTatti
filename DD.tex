...
\newpage
	...
	\begin{figure}
		...
		\begin{minipage}{.45\textwidth}
			\centering
			\includegraphics[width=.4\linewidth]{img/mockups/mobile/register.png}
			\caption{Mockup for registration on mobile device.}
			\label{fig:test1}
		\end{minipage}
		\begin{minipage}{.45\textwidth}
			\centering
			\includegraphics[width=.4\linewidth]{img/mockups/mobile/login.png}
			\caption{Mockup for login on mobile device.}
			\label{fig:test2}
		\end{minipage}
	\end{figure}
	...
	\begin{figure}
		...
		\begin{minipage}{.45\textwidth}
			...
			\caption{Mockup for list view of events on mobile device.}
			\label{fig:test1}
		\end{minipage}
		\begin{minipage}{.45\textwidth}
			\centering
			\includegraphics[width=.4\linewidth]{img/mockups/mobile/calendar.png}
			\caption{Mockup for calendar view of events on mobile device.}
			\label{fig:test2}
		\end{minipage}
	\end{figure}
	...
	\begin{figure}
		...
		\begin{minipage}{.45\textwidth}
			...
			\caption{Mockup for map view of events on mobile device.}
			\label{fig:test1}
		\end{minipage}
		\begin{minipage}{.45\textwidth}
			\centering
			\includegraphics[width=.4\linewidth]{img/mockups/mobile/event.png}
			\caption{Mockup for event view on mobile device.}
			\label{fig:test2}
		\end{minipage}
	\end{figure}
