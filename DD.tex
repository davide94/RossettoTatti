...
\newpage
	...
	\item [forgotPassword] -- This procedure is used when the user has forgotten the login credentials for the application. It returns the correct email address and password.
	...
	\begin{itemize}
	\item \textit{location} entity, in order to keep user’s position updated and calculate the location of the meeting. It also calculates the path to reach the event.
	\end{itemize}
